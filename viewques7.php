...
$sql = "SELECT question FROM questions where qid=7";
...
if (mysqli_num_rows($res) > 0) {
    echo  "<h2 style='color:blue;'> Question 7 out of 10</h2>";
...
$dbname="quizdb";
$con=mysqli_connect($host,$dbusername,$dbpassword,$dbname);
$sql = "SELECT  answer FROM answers where ans_id=7";
$res=mysqli_query($con,$sql);

if (mysqli_num_rows($res) > 0) {

     echo "<form action = 'viewques8.php' method = 'POST'>";
