...
$sql = "SELECT question FROM questions where qid=3";
...
if (mysqli_num_rows($res) > 0) {
    echo  "<h2 style='color:blue;'> Question 3 out of 10</h2>";
...
$dbname="quizdb";
$con=mysqli_connect($host,$dbusername,$dbpassword,$dbname);
$sql = "SELECT  answer FROM answers where ans_id=3";
$res=mysqli_query($con,$sql);

if (mysqli_num_rows($res) > 0) {

     echo "<form action = 'viewques4.php' method = 'POST'>";
