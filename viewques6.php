...
$sql = "SELECT question FROM questions where qid=6";
...
if (mysqli_num_rows($res) > 0) {
    echo  "<h2 style='color:blue;'> Question 6 out of 10</h2>";
...
$dbname="quizdb";
$con=mysqli_connect($host,$dbusername,$dbpassword,$dbname);
$sql = "SELECT  answer FROM answers where ans_id=6";
$res=mysqli_query($con,$sql);

if (mysqli_num_rows($res) > 0) {

     echo "<form action = 'viewques7.php' method = 'POST'>";
